    ...
    <div class='container'>
        <div class='row single-product'>
                        ...
                        <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <img src="<?php echo base_url(); ?>assets/themes/default/images/hot-deals/p5.jpg" alt="">
                                        </div>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <img src="<?php echo base_url(); ?>assets/themes/default/images/products/p6.jpg" alt="">
                                        </div>
                                        <div class="sale-offer-tag"><span>35%<br>off</span></div>
                                        <div class="timing-wrapper">
                                            <div class="box-wrapper">
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <img src="<?php echo base_url(); ?>assets/themes/default/images/products/p7.jpg" alt="">
                                        </div>
                                        <div class="sale-offer-tag"><span>35%<br>off</span></div>
                                        <div class="timing-wrapper">
                                            <div class="box-wrapper">
            ...
            <div class='col-md-9'>
                    ...
                    <div class="row  wow fadeInUp">
                            ...
                            <div class="product-item-holder size-big single-product-gallery small-gallery">
                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide11">
                                        <a data-lightbox="image-1" data-title="Gallery" href="<?php echo base_url().$product_details['thumb_image']; ?>">
                                            <img class="img-responsive" alt="" src="<?php echo base_url().$product_details['thumb_image']; ?>" data-echo="<?php echo base_url().$product_details['thumb_image']; ?>" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->
                                    <?php

                                    	$products_images = unserialize($product_details['images']);
                                    ...
                                    <div id="owl-single-product-thumbnails">
                                        <div class="item">
                                            <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="11" href="#slide11">
                                                <img class="img-responsive" width="85" alt="" src="<?php echo base_url().$product_details['thumb_image']; ?>" data-echo="<?php echo base_url().$product_details['thumb_image']; ?>" />
                                            </a>
                                        </div>
                                        <?php
                                        	$products_images = unserialize($product_details['images']);
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                <h1 class="name"><?php echo ucwords($product_details['name']); ?></h1>
                                ...
                                <div class="description-container m-t-20">
                                    <?php echo ucfirst($product_details['short_description']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                ...
                                                <span class="price-strike"><?php echo $product_details['old_price']; ?></span>
                                            </div>
                                        </div>

                                        <div class="col-sm-6">
                                            <div class="favorite-button m-t-10">
                                                <a class="btn btn-info" data-toggle="tooltip" data-placement="top" title="vendor" href="<?php echo base_url('home/store/').$product_details['vendor_id']; ?>">
                                                    <?php echo ucwords(get_vendor_info($product_details['vendor_id'], 'shop_name')); ?>
                                                </a>
                                            </div>
                                        </div>
                                    </div><!-- /.row -->
                                            ...
                                            <div class="cart-quantity">
                                                <div class="quant-input">
                                                    ...
                                                    <div class="arrows">
                                                        ...
                                                        <div class="arrow plus gradient" ><span class="ir" ><i class="icon fa fa-sort-asc" onclick="increment_quntity('<?php echo $product_details['quantity']; ?>')"></i></span></div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text"><?php echo ucfirst($product_details['long_description']); ?> </p>
                                    </div>
                                </div><!-- /.tab-pane -->
                                <?php
                ...
                <!-- ============================================== RELATED PRODUCTS ============================================== -->
                <?php $related_products = unserialize($product_details['related_products']);
                            ...
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image">
                                            <a href="<?php echo base_url().$product_info['thumb_image']; ?>" target="_blank"><img  src="<?php echo base_url().$product_info['thumb_image']; ?>" alt=""></a>
                                        </div><!-- /.image -->
                                        <?php

                                        			if ($product_info['is_sale'] == 1)
                                        			{
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="<?php echo base_url('products/show_details/').$product_info['id']; ?>"><?php echo ucwords($product_info['name']); ?></a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>

                                        <div class="product-price">
                                            <span class="price"><?php echo '&#8377;'.'. '.$product_info['price']; ?></span>
                                            <span class="price-before-discount"><?php echo '&#8377;'.'. '.$product_info['old_price']; ?></span>
                                        </div><!-- /.product-price -->
