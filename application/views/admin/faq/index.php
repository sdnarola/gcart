    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading mt-20">
            <div class="heading-elements">
                <a href="<?php echo base_url('admin/faq/add'); ?>" class="btn btn-primary btn-sm"><?php _el('add_new');?><i class="icon-plus-circle2 position-right"></i></a>
            ...
            <table id="categories_table" class="table  table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="45%" ><?php _el('faq_title');?></th>
                        <th width="45%"><?php _el('faq_details');?></th>
...
<?php
	...
	?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('edit')?>" href="<?php echo site_url('admin/faq/edit/').$record['id']; ?>" id="<?php echo $record['id']; ?>" class="text-info">
...
function delete_selected()
{
    ...
    {
        $.ajax({
            url:BASE_URL+'admin/faq/delete_multiple',
            type: 'POST',
            data: {
              ids:faq_ids
            },
