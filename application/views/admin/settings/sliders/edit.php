...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <span class="text-semibold"><?php _el('edit_slider'); ?></span>
            </h4>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                     <form action="<?php echo base_url('admin/sliders/edit/'). $slider['id']; ?>" id="sliders_form" method="POST" enctype="multipart/form-data">
                        <div class="col-md-12">
...
?>
                            ...
                            <div class="form-group">
                                <input type="file"  class="file-input"  name="image" id='image' data-show-caption="false" data-show-upload="false">
                            </div>
                        </div> 
                        <div class="row">
