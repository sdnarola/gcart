                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" placeholder="<?php _el('limitations'); ?>" id="limitations" name="limitations" value="<?php echo $plan['product_limit'];?>">
                                </div>
                        </div>
                            <div class="form-group">
                                <div>
                                ...
                                <textarea id="description" name="description" cols="136" rows="5" placeholder="<?php _el('description');?>"><?php echo $plan['description'];?></textarea>
