        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url('admin/coupons/edit/').$coupon['id']; ?>" id="coupon_form" method="POST" enctype="multipart/form-data">
                    	<!-- code -->
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
	                            ...
	                            <select class="form-control select-search" name="type" id="type" onchange="enable_discount();">
                                    ...
                                    <option value="0"<?php
                                                     ...
                                                     ?>><?php _el('discount_amount')?>   </option>
                                    <option value="1"<?php
                                                     ...
                                                     ?>><?php _el('discount_percentage')?></option>
                                </select>
                            </div>
                        </div>
                        <!-- discount add -->
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
	                            ...
	                            <input type="date" name="start_date" id="start_date" placeholder="<?php _el('start_date');?>"  class="form-control" min="<?php echo date('yy-m-d'); ?>" value="<?php echo date('Y-m-d', strtotime($coupon['start_date'])); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
	                            ...
	                            <input type="date" name="end_date" id="end_date" placeholder="<?php _el('end_date');?>"  class="form-control" min="<?php echo date('yy-m-d'); ?>"value="<?php echo date('Y-m-d', strtotime($coupon['end_date'])); ?>">
                            </div>
                        </div>
                        <!-- buttons -->
                        <div class="row">
...
{
    var discount =  $('#type option:selected').val();//value of the selected discount option.
    ...
    if(discount == 0)
    {
    	...
    	$('#discount').remove();
    	$('#discount_row').append('<div class="form-group col-md-12 has-feedback " id="discount"><small class="req text-danger">* </small><label><?php _el('amount');?>:</label> <input type="text" Class="form-control" placeholder="<?php _el('amount');?>" id="amount" name="amount" value="<?php echo $coupon['amount'] ?>"><div class="form-control-feedback"><?php echo '&#8377;'; ?></div></div>');
    }
    ...
    else if(discount == 1)
    {
    	$('#discount_row').removeClass('hidden');
    	$('#discount').remove();
    	$('#discount_row').append('<div class="form-group col-md-12 has-feedback " id="discount"><small class="req text-danger">* </small><label><?php _el('percentage');?>:</label> <input type="text" Class="form-control" placeholder="<?php _el('percentage');?>" id="percentage" max="100" name="amount" value="<?php echo $coupon['amount'] ?>"><div class="form-control-feedback"><?php echo '&#37;'; ?></div></div>');
    }
}
...
{
    var quantity =  $('#quantity option:selected').val();;//value of the selected quantity option.
    ...
    if(quantity == 0)
    {
    	...
    	$('#quantity_row').append('<div class="form-group col-md-12 " id="quantity_input"><small class="req text-danger">* </small><label><?php _el('value');?>:</label><input type="text" class="form-control" placeholder="<?php _el('value');?>" id="value" name="value"  value="<?php echo $coupon['quantity'] ?>"></div>');
    }
