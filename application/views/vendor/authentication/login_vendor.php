<!-- Simple login form -->
<form action="<?php echo vendor_url('authentication/'); ?>" id="loginform" method="POST">
		...
		<div class="form-group login-options">
			<div class="row">
				...
				<div class="col-sm-6 text-right">
					<a href="<?php echo vendor_url('authentication/forgot_password'); ?>"><?php _el('forgot_password')?></a>
				</div>
			</div>
		</div>
