                ...
                <div class="col-md-6">
                    <table  class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td><?php echo 'Rs'.'. '.$order['grand_total']; ?></td>
                 ...
                 <table  class="table-responsive">
                     ...
                     <?php foreach ($address as $address)
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td><?php echo ucwords($address['address_1'].', '.$address['address_2']); ?></td>
                        ...
                        <div class="col-md-12">
                            <table  class="table-responsive">                             
                                ...
                                <tr>
                                    ...
                                    <td><?php echo 'Rs'.'. '.$item['total_amount']; ?></td>
                               ...
                               <?php 
                                ...
                                <tr rowspan="2" style="border-top: 1px solid #ddd;"><td><b>Amount in Words<?php echo str_repeat("&nbsp;",1); ?>:<?php echo str_repeat("&nbsp;",1); ?></b><br></td><td colspan="2"><?php echo no_to_words($order['grand_total']);?></td><td colspan="3" class="text-right"><strong><?php _el('grand_total');?></strong></td><td><?php echo 'Rs'.'. '.$order['grand_total']; ?></td></tr>
                            </table>
                              <br> 
                              <br>  
                              <hr>        
