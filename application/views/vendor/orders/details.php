                                ...
                                <tr>
                                    ...
                                    <td width="40%">
                                        <?php
                                        	...
                                        	{
                                        		echo '<span class="label label-danger label-rounded">Unpaid</span>';}

                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-center"><a href="<?php echo base_url('vendor/orders/invoice/').$order['order_id']; ?>" class="btn btn-sm bg-teal-400 btn-labeled"><b><i class="icon-calculator4"></i></b>View Invoice</a>
                                </tr>
