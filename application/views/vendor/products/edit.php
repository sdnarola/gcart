        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url('vendor/products/edit/').$product['id']; ?>" id="product_form" method="POST" enctype="multipart/form-data">
                        <div class="row">
...
?>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="long_description" id="long_description" class="form-control summernote" rows="10"><?php echo $product['long_description']; ?></textarea>
