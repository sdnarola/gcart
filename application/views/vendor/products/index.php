...
<?php
	...
	?>>
                ...
                <td class="text-center">
                    <a data-popup="tooltip" data-placement="top"  title="<?php _el('details')?>" href="<?php echo site_url('vendor/products/details/'.$product['id']); ?>" id="<?php echo $product['id']; ?>" class="text-slate"><i class=" icon-eye"></i></a>
...
function change_status(obj)
{
    ...
    $.ajax({
        url:BASE_URL+'vendor/products/update_status',
        type: 'POST',
        data: {
            product_id: obj.id,
            is_active:checked
...
function delete_record(id)
{
    ...
    {
        $.ajax({
            url:BASE_URL+'vendor/products/delete',
            type: 'POST',
            data: {
                product_id:id
            },
...
function delete_selected()
{
    ...
    {
        $.ajax({
            url:BASE_URL+'vendor/products/delete_selected',
            type: 'POST',
            data: {
              ids:product_ids
            },
